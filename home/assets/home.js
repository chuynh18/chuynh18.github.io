...
window.onload = function() {
    const tiles = [
        ...
        {img: "nys.jpg", half: "nyssmall.jpg", desc: "<p class='links-row'><a href='https://nyskyscraper.herokuapp.com/' target='_blank'><img src='assets/img/eye.svg' alt='Try it' class='icon-link'></a><a href='https://github.com/chuynh18/mongoose-scraper' target='_blank'><img src='assets/img/mark-github.svg' alt='See the code' class='icon-link'></a></p>"},
        {img: "tic.jpg", half: "ticsmall.jpg", desc: "<p class='links-row'><a href='https://chuynh18.github.io/tictactoe/' target='_blank'><img src='assets/img/eye.svg' alt='Try it' class='icon-link'></a><a href='https://github.com/chuynh18/tictactoe' target='_blank'><img src='assets/img/mark-github.svg' alt='See the code' class='icon-link'></a></p>"},
        {img: "shiritori.jpg", half: "shiritorismall.jpg", desc: "<p class='links-row'><a href='https://chuynh18.github.io/shiritori/' target='_blank'><img src='assets/img/eye.svg' alt='Try it' class='icon-link'></a><a href='https://github.com/chuynh18/shiritori' target='_blank'><img src='assets/img/mark-github.svg' alt='See the code' class='icon-link'></a></p>"},
        {img: "snake.jpg", half: "snakesmall.jpg", desc: "<p class='links-row'><a href='https://chuynh18.github.io/snake/' target='_blank'><img src='assets/img/eye.svg' alt='Try it' class='icon-link'></a><a href='https://github.com/chuynh18/snake' target='_blank'><img src='assets/img/mark-github.svg' alt='See the code' class='icon-link'></a></p>"}
    ];
