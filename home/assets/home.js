...
window.onload = function() {
    ...
    const tiles = [
        ...
        {img: "tic.jpg", half: "ticsmall.jpg", desc: "<p>Tic-tac-toe, written in HTML, CSS, and JavaScript.  Game records are saved via localStorage.  The AI plays a perfect game.  A small twist of my implementation is the hint button, which basically just shows the play(s) that the AI would have made.  Take a look at the <a href='https://github.com/chuynh18/tictactoe#tic-tac-toe'>README.md</a> for a deeper dive.</p><div class='link-item'><a href='https://chuynh18.github.io/tictactoe/' target='_blank'><img src='assets/img/eye.svg' alt='Try it' class='icon-link'><span class='icon-text'>Try It</span></a></div><div class='link-item'><a href='https://github.com/chuynh18/tictactoe' target='_blank'><img src='assets/img/mark-github.svg' alt='See the code' class='icon-link'><span class='icon-text'>GitHub</span></a></div>"},
