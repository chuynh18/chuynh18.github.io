...
window.onload = function() {
    const tiles = [
        ...
        {img: "nys.jpg", half: "nyssmall.jpg", desc: "<p>This is a small, full stack web application that scrapes headlines and links off of the New York Times.  It can target either the home page or any of the main sections.  The backend is JavaScript running in a Node environment (with Express and Mongoose/MongoDB), and deployed to a hobby instance on Heroku.  The front end is pure HTML, CSS, and JavaScript — no libraries.  The front end communicates with the back end via XMLHttpRequest.</p><p class='links-row'><a href='https://nyskyscraper.herokuapp.com/' target='_blank'><img src='assets/img/eye.svg' alt='Try it' class='icon-link'></a><a href='https://github.com/chuynh18/mongoose-scraper' target='_blank'><img src='assets/img/mark-github.svg' alt='See the code' class='icon-link'></a></p>"},
        {img: "tic.jpg", half: "ticsmall.jpg", desc: "<p>Tic-tac-toe, written in HTML, CSS, and JavaScript.  Game records are saved via localStorage.  The AI plays a perfect game.  A small twist of my implementation is the hint button, which basically just shows the play(s) that the AI would have made.  Take a look at the README.md for a deeper dive.</p><p class='links-row'><a href='https://chuynh18.github.io/tictactoe/' target='_blank'><img src='assets/img/eye.svg' alt='Try it' class='icon-link'></a><a href='https://github.com/chuynh18/tictactoe' target='_blank'><img src='assets/img/mark-github.svg' alt='See the code' class='icon-link'></a></p>"},
