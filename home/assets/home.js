...
window.onload = function() {
    const tiles = [
        ...
        {img: "snake.jpg", half: "snakesmall.jpg", desc: "<p>A classic game.  My implementation is written in pure HTML, CSS, and JavaScript.  I wanted to try my hand at writing a simple real-time game in JavaScript, and I'm glad I took on the challenge.  My initial version ran without issues on computers, but had performance issues on mobile devices.  Please see the <a href='https://github.com/chuynh18/snake#optimization' target='_blank'>optimization section of the README.md</a> for a closer look.</p><div class='link-item'><a href='https://chuynh18.github.io/snake/' target='_blank'><img src='assets/img/eye.svg' alt='Try it' class='icon-link'><span class='icon-text'>Try It</span></a></div><div class='link-item'><a href='https://github.com/chuynh18/snake' target='_blank'><img src='assets/img/mark-github.svg' alt='See the code' class='icon-link'><span class='icon-text'>GitHub</span></a></div>"}
    ];
